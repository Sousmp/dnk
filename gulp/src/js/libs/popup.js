...
class Popup {
	...
	close(selectorValue) {
		...
		if (this.openPopupsCount === 0 && !document.documentElement.classList.contains('menu-open')) {
			this.bodyLock = false; // Сбрасываем флаг bodyLock, если все попапы закрыты и нет класса menu-open
		}
